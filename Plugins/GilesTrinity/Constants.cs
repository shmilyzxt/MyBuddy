...
namespace GilesTrinity
{
    public static class Constants
    {
        ...
        internal static double[] MaxPointsWeaponTwoHand = new double[29] { 530, 530, 530, 530, 0, 1800, 5.8, 0, 0, 0, 0, 0, 1, 0, 170, 0, 0, 0, 0, 0, 0, 0, 1590, 0, 10, 119, 10, 14, 0 };
        internal static double[] MaxPointsWeaponOneHand = new double[29] { 320, 320, 320, 320, 0, 850, 2.8, 0, 0, 0, 0, 0, 1, 0, 85, 0, 0, 0, 0, 0, 0, 0, 1210, 0, 10, 150, 10, 14, 0 };
        ...
        internal static double[] MaxPointsShield = new double[29] { 330, 330, 330, 330, 16, 0, 0, 342, 20, 25, 0, 0, 1, 10, 0, 0, 0, 0, 30, 2544, 80, 60, 0, 397, 0, 0, 0, 0, 12794 };
        ...
        internal static double[] MaxPointsShoulders = new double[29] { 200, 200, 300, 200, 12, 0, 0, 342, 20, 25, 0, 7, 0, 0, 0, 0, 0, 0, 0, 2544, 80, 60, 0, 265, 0, 0, 0, 0, 12794 };
        internal static double[] MaxPointsHelm = new double[29] { 200, 300, 200, 200, 12, 0, 0, 342, 20, 25, 0, 7, 1, 6, 0, 0, 0, 0, 0, 1454, 80, 60, 0, 397, 0, 0, 0, 0, 12794 };
        internal static double[] MaxPointsPants = new double[29] { 200, 200, 200, 300, 0, 0, 0, 342, 20, 25, 0, 7, 2, 0, 0, 0, 0, 0, 0, 1454, 80, 60, 0, 397, 0, 0, 0, 0, 12794 };
        internal static double[] MaxPointsGloves = new double[29] { 300, 300, 200, 200, 0, 0, 0, 342, 20, 25, 0, 7, 0, 10, 50, 9, 0, 0, 0, 1454, 80, 60, 0, 265, 0, 0, 0, 0, 12794 };
        ...
        internal static double[] MaxPointsBracer = new double[29] { 200, 200, 200, 200, 0, 0, 0, 342, 20, 25, 0, 7, 0, 6, 0, 0, 0, 0, 0, 1454, 80, 60, 0, 265, 0, 0, 0, 0, 12794 };
        internal static double[] MaxPointsBoots = new double[29] { 300, 200, 200, 200, 0, 0, 0, 342, 20, 25, 12, 7, 0, 0, 0, 0, 0, 0, 0, 1454, 80, 60, 0, 265, 0, 0, 0, 0, 12794 };
        internal static double[] MaxPointsBelt = new double[29] { 200, 200, 300, 200, 12, 0, 0, 342, 20, 25, 0, 7, 0, 0, 0, 0, 0, 0, 0, 2544, 80, 60, 0, 265, 0, 0, 0, 0, 12794 };
        ...
        internal static double[] MaxPointsMightyBelt = new double[29] { 200, 200, 300, 200, 12, 0, 3, 342, 20, 25, 0, 7, 0, 0, 0, 0, 0, 0, 0, 2544, 70, 50, 0, 265, 0, 0, 0, 0, 12794 };
        internal static double[] MaxPointsSpiritStone = new double[29] { 200, 300, 200, 200, 12, 0, 0, 342, 20, 25, 0, 7, 1, 6, 0, 0, 0, 0, 0, 1454, 70, 50, 0, 397, 0, 0, 0, 0, 12794 };
        internal static double[] MaxPointsVoodooMask = new double[29] { 200, 300, 200, 200, 12, 0, 0, 342, 20, 25, 0, 7, 1, 6, 0, 0, 0, 0, 0, 1454, 70, 50, 0, 397, 0, 119, 0, 11, 12794 };
        internal static double[] MaxPointsWizardHat = new double[29] { 200, 300, 200, 200, 12, 0, 0, 342, 20, 25, 0, 7, 1, 6, 0, 0, 0, 0, 0, 1454, 70, 50, 0, 397, 0, 0, 10, 0, 12794 };
        ...
        */
        ...
        internal static double[] WeaponPointsAtMax = new double[29] { 4000, 4000, 4000, 2000, 2000, 7000, 7000, 1000, 2000, 2000, 10000, 500, 15000, 10000, 10000, 0, 0, 0, 0, 0, 13000, 0, 60000, 0, 10000, 8500, 8500, 2000, 1000 };
        ...
        //// Note that these values get all sorts of bonuses, multipliers, and extra things applied in the actual scoring routine. These values are more of a "base" value.
        ////                                                              Dex    Int    Str    Vit    Life%  LOH    Steal% LPS   Magic%  Gold%  MSPD   Rad  Sox    Crit%  CDam%  ASPD   Min+  Max+ Block% Thorn Allres Res   DPS    ARMOR  Disc.  Mana  Arc.  Regen  Globes
        //internal static double[] WeaponPointsAtMax = new double[29] { 14000, 14000, 14000, 14000, 13000, 20000, 7000, 1000, 6000, 6000, 6000, 500, 16000, 15000, 15000, 0, 0, 0, 0, 1000, 11000, 0, 64000, 0, 10000, 8500, 8500, 10000, 8000 };
        ////                                                              Dex    Int    Str    Vit    Life%  LOH    Steal% LPS   Magic%  Gold%  MSPD   Rad. Sox    Crit%  CDam%  ASPD   Min+  Max+ Block% Thorn Allres Res   DPS    ARMOR  Disc.  Mana  Arc.  Regen  Globes
